// Get audio elements
        ...
        function checkAnswers() {
            ...
            document.querySelectorAll('.question').forEach(question => {
                ...
                if (selectedOption) {
                    ...
                    // For questions with multiple correct answers (e.g., "become deaf / be deaf")
        ...
        function goBack() {
            // In a real implementation, this would navigate to the main page
            alert("This would navigate back to the main page in a real implementation");
        }